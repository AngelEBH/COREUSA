<%@ Page Language="C#" AutoEventWireup="true" Inherits="Gestion_ImprimirConvenio" Codebehind="ImprimirConvenio.aspx.cs" %>
    ...
    <form id="form1" runat="server" style="background-color:white;">
            <asp:Panel CssClass="FormatoPanelContenedorNOAB"  ID ="Panel1" runat="server" style="width:880px; ">
                        ...
                        <tr>
                            <td>
                                <table style="width:100%;">
                                    <tr>
                                        <td class="ClaseTDDerechaBold" style="vertical-align:bottom;" >Total adeudado:</td>
                                        ...
                                        <td class="ClaseTDDerechaBold" style="vertical-align:bottom;">Descuento:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ClaseTDBUR" style="vertical-align:bottom; height:24px; width:150px;"><asp:Label runat="server" ID="lblAbonoInicial" style="left:  260px; top:108px; " Text=""/></td>
                                        <td style="width:50px;">&nbsp;</td>
                                        <td class="ClaseTDDerechaBold">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="ClaseTDDerechaBold" style="vertical-align:bottom; height: 24px">Cuota del convenio:</td>
                ...
                <div style="margin-left:5px; margin-right:5px;">
                    <table>
                        <tr><td class="ClaseTDJ">&nbsp;</td></tr>
                        <tr><td class="ClaseTDJ"><p>El presente convenio se establece y firma para constancia, el día: <asp:label runat="server" ID="lblDiadeFirma" Text=""/> en la ciudad de <asp:label runat="server" ID="lblCiudadAgencia" Text=""/>, Departamento de <asp:label runat="server" ID="lblDepartamentoAgencia" Text=""/>, Honduras.</p></td></tr>
                        <tr><td class="ClaseTDJ">&nbsp;</td></tr>
                        <tr><td class="ClaseTDJ">&nbsp;</td></tr>
                    </table>
                </div>
                <div style="margin-left:5px; margin-right:5px;">
                    <table>
                        <tr><td class="ClaseTDJ">&nbsp;</td></tr>
                        <tr><td class="ClaseTDJ" style="height: 19px"></td></tr>
                        <tr><td class="ClaseTDJ">&nbsp;</td></tr>
                        <tr><td class="ClaseTDJ">&nbsp;</td></tr>
                        <tr><td class="ClaseTDJ">&nbsp;</td></tr>
                        <tr><td class="ClaseTDJ">&nbsp;</td></tr>
