<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeguimientoColadeLlamadas.aspx.cs" Inherits="SeguimientoColadeLlamadas" %>
            ...
            <div class="table-responsive p-0">
                <div class="btn-group btn-group-toggle col-lg-12 p-0" data-toggle="buttons">
                    ...
                    <label class="btn btn-success">
                        ...
                        <a href="#" class="text-white">Llamdas Para Hoy</a>
                    </label>
                    <label class="btn btn-info">
                        <input id="analisis" type="radio" name="filtros" value="futuras" />
                        <a href="#" class="text-white">Llamadas Hechas</a>
                    </label>
