...
public partial class SeguimientoColadeLlamadas : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static List<SeguimientoColadeLlamadasViewModel> CargarSolicitudes(string dataCrypt)
    {
        List<SeguimientoColadeLlamadasViewModel> ListadoRegistros = new List<SeguimientoColadeLlamadasViewModel>();
        try
        {
            ...
            while (reader.Read())
            {
                ListadoRegistros.Add(new SeguimientoColadeLlamadasViewModel()
                {
...
public class SeguimientoColadeLlamadasViewModel
{
