...
public partial class Clientes_Precalificado_Puesto110 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (pcBuscarDatos == "0")
        {
            ...
            try
            {
                ...
                if(HttpContext.Current.Session["PrecalificandoAval"] != null)
                {
                    if ((bool)HttpContext.Current.Session["PrecalificandoAval"])
                    {
                        btnIngresarSolicitud.Visible = false;
                        btnRegistrarAval.Visible = true;
                    }
                }
            ...
            btnSolicitarRevision.Visible = false;
        }
    }
    ...
    protected void btnIngresarSolicitud_Click(object sender, EventArgs e)
    {
        ...
        string lcScript = "window.open('/Forms/Solicitudes/SolicitudesCredito_Registrar.aspx?" + DSC.Encriptar(lcParametroEncriptar) + "','_Clientes_Contenido')";
        Response.Write("<script>");
        Response.Write(lcScript);
        Response.Write("</script>");
    }
