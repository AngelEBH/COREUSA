    ...
    <form id="form1" runat="server">
                        ...
                        <div class="form-group row EliminarEspacios">
                            ...
                            <div class="col-md-8">
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <button id="btnHistorialExterno" class="btn btn-sm btn-block btn-success btn-block waves-effect waves-light" type="button">
                                            Buro externo
                                        </button>
                                    </div>
                                    <div class="col-sm-3">
                                        <button id="btnCondicionarSolicitud" class="btn btn-sm btn-block btn-warning btn-block validador" runat="server" data-toggle="modal" data-target="#modalCondicionarSolicitud" type="button">
                                            Condicionar
                                        </button>
                                    </div>
                                    <div class="col-sm-2">
                                        <button id="btnValidoDocumentacionModal" class="btn btn-sm btn-block btn-success btn-block waves-effect waves-light float-right" data-toggle="modal" data-target="#modalDocumentos" type="button">
                                            <small>Ver docs</small>
                                        </button>
                                    </div>
                                    <div class="col-sm-2">
                                        <button id="btnRechazar" class="btn btn-sm btn-block btn-danger waves-effect waves-light" data-toggle="modal" data-target="#modalResolucionRechazar" type="button">
                                            Rechazar
                                        </button>
                                    </div>
                                    <div class="col-sm-2">
                                        <button id="btnAceptarSolicitud" class="btn btn-sm btn-block btn-warning waves-effect waves-light" disabled="disabled" data-toggle="modal" data-target="#modalResolucionAprobar" title="" type="button">
                                            Aceptar
                                        </button>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 border">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <asp:Label ID="lblPlazoTitulo" CssClass="col-sm-6" runat="server">Plazo</asp:Label>
        ...
        <div id="modalResolucionAprobar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalResolucionAprobarLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="modalResolucionAprobarLabel">Rechazar solicitud</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button id="btnAceptarSolicitudConfirmar" class="btn btn-danger waves-effect waves-light mr-1">
                            Confirmar
                        </button>
                        <button type="reset" data-dismiss="modal" class="btn btn-secondary waves-effect">
                            Cancelar
