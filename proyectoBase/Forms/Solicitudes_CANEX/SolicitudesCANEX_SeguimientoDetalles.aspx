    ...
    <form id="form1" runat="server">
                        ...
                        <div class="form-group row EliminarEspacios">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <button id="btnListaCondiciones" class="btn btn-sm btn-block btn-success btn-block validador" runat="server" visible="false" data-toggle="modal" data-target="#modalListaCondiciones" type="button">
                                            Lista de condiciones
                                        </button>
                                    </div>
                                    <div class="col-sm-3">
                                        <button id="btnValidoDocumentacionModal" data-toggle="modal" data-target="#modalDocumentos" type="button" class="btn btn-sm btn-success btn-block waves-effect waves-light float-right">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 border">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label class="col-sm-6 col-form-label" id="lblTituloValorPMO">Valor Global</label>
                                                                    <asp:Label ID="lblValorGlobal" CssClass="col-sm-6" runat="server"></asp:Label>

                                                                    <label id="lblValorPrimaTitulo" class="col-sm-6 col-form-label">Valor Prima</label>
                                                                    ...
                                                                    <label class="col-sm-6 col-form-label">Monto Financiar</label>
        ...
        <div id="modalListaCondiciones" class="modal fade bs-example-modal-lg" role="dialog" aria-labelledby="modalListaCondicionesLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="modalListaCondicionesLabel">Condiciones de la solicitud</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">                    
