...
public partial class Solicitudes_CANEX_Detalles : System.Web.UI.Page
{
    ...
    public int IDSolcitudPrestadito = 0;
            ...
            try
            {
                ...
                if (lcParametros != String.Empty)
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        IDSolcitudPrestadito = (int)reader["fiIDSolicitudPrestadito"];
                        ...
                        if (reader.HasRows)
                        {
                            pestanaListaSolicitudCondiciones.Visible = true;
    ...
    [WebMethod]
    public static bool CondicionarSolicitud(List<SolicitudesCondicionamientosViewModel> SolicitudCondiciones, int IDPais, int IDSocio, int IDAgencia)
    {
        SqlConnection sqlConexion = null;
        SqlDataReader reader = null;
    ...
    [WebMethod]
    public static int SolicitudResolucion(int IDEstado, int IDPais, int IDSocio, int IDAgencia)
    {
        SqlConnection sqlConexion = null;
        SqlDataReader reader = null;
    ...
    [WebMethod]
    public static ResponseEntitie ImportarSolicitud(int IDPais, int IDSocio, int IDAgencia)
    {
        SqlConnection sqlConexion = null;
        SqlDataReader reader = null;
        DSCore.DataCrypt DSC = new DSCore.DataCrypt();
        ...
        try
        {
            ...
            if (ResultadoSp == true)
            {
                ...
                sqlComando = new SqlCommand("CoreFinanciero.dbo.sp_CANEX_Solicitud_Documentos", sqlConexion);
                sqlComando.CommandType = CommandType.StoredProcedure;
                sqlComando.Parameters.AddWithValue("@piIDSolicitud", IDSOL);
                sqlComando.Parameters.AddWithValue("@piIDSesion", pcIDSesion);
                sqlComando.Parameters.AddWithValue("@piIDApp", pcIDApp);
            ...
            {
                using (sqlComando = new SqlCommand("CoreFinanciero.dbo.sp_CREDSolicitud_Documentos_Insert", sqlConexion))
                {
                    sqlComando.CommandType = CommandType.StoredProcedure;
