...
public partial class SolicitudesCredito_Analisisv2 : System.Web.UI.Page
{
    ...
    public bool ValidarAnalista(int IDSolicitud)
    {
        ...
        try
        {
            using (SqlConnection sqlConexion = new SqlConnection(DSC.Desencriptar(ConfigurationManager.ConnectionStrings["ConexionEncriptada"].ConnectionString)))
            {
                ...
                string NombreLogo = IDPRODUCTO == 101 ? "iconoRecibirDinero48.png" : IDPRODUCTO == 201 ? "iconoMoto48.png" : (IDPRODUCTO == 202 || IDPRODUCTO == 203 || IDPRODUCTO == 204) ? "iconoAuto48.png" : IDPRODUCTO == 301 ? "iconoConsumo48.png" : "iconoConsumo48.png";
