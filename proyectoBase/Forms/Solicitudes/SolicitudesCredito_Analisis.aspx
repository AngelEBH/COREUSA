            ...
            <div class="row">
                ...
                <div class="col-md-6 form-inline justify-content-end pr-0">
                    ...
                    <div class="button-items">
                        ...
                        <!--<asp:HyperLink ID="btnLinkDocumentos" runat="server" type="button" target="newpage" class="btn btn-warning waves-effect waves-light"> Validar Documentos</asp:HyperLink>-->

                        <!--<button id="btnValidarDocumentos"  title="" type="button" class="btn btn-sm btn-warning waves-effect waves-light validador">
                            Validar Documentos
                        </button>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                <div class="col-sm-12" style="visibility:hidden; height: 0px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                ...
                                                <asp:Label ID="lblMunicipioCliente" CssClass="col-sm-6" runat="server" Visible="false"></asp:Label>
                                                </div>
                                                
                                                <label class="col-sm-6">Provincia</label>
                                                <asp:Label ID="lblCiudadCliente" CssClass="col-sm-6" runat="server"></asp:Label>

                                                <label class="col-sm-6">Codigo Postal</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group row">
                                                ...
                                                <label class="col-sm-6"  style="display:none;">Arraigo laboral</label>
                                                ...
                                                <label class="col-sm-6"  style="display:none;" >Extensión RRHH</label>
                                                <asp:Label ID="lblExtensionRecursosHumanos" CssClass="col-sm-6" runat="server"></asp:Label>

                                                <label class="col-sm-6"  style="display:none;" >Extensión cliente</label>
                                                <asp:Label ID="lblExtensionCliente" CssClass="col-sm-6" runat="server"></asp:Label>

                                                <label class="col-sm-6">Estado empresa</label>
                                                <asp:Label ID="lblDeptoEmpresa" CssClass="col-sm-6" runat="server"></asp:Label>
                                                <div class="col-sm-12" style="visibility:hidden; height: 0px;">
                                                <label class="col-sm-6" style="visibility:hidden;">Municipio empresa</label>
                                                <asp:Label ID="lblMunicipioEmpresa" CssClass="col-sm-6" runat="server" Visible="false"></asp:Label>
                                                </div>
                                                <label class="col-sm-6">Provincia empresa</label>
                                                <asp:Label ID="lblCiudadEmpresa" CssClass="col-sm-6" runat="server"></asp:Label>

                                                <label class="col-sm-6">Codigo Postal/ empresa</label>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <label class="mt-0 header-title text-center">Documentación del negocio</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="ResumenSolicitud">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-6 EliminarEspacios">Estado</label>
                        <asp:Label ID="lblResumenDeptoResidencia" CssClass="col-sm-6 EliminarEspacios" runat="server"></asp:Label>
                        <label class="col-sm-6 EliminarEspacios" style="visibility:hidden;">Municipio Residencia</label>
                        <asp:Label ID="lblResumenMuniResidencia" CssClass="col-sm-6 EliminarEspacios" runat="server" Visible="false"></asp:Label>
