<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudesCredito_NoAsignadas.aspx.cs" Inherits="SolicitudesCredito_NoAsignadas" %>
...
<body class="EstiloBody-Listado-W1100px">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-8">
                    <h6>Solicitudes pendientes de asignar gestor</h6>
                </div>
                <div class="col-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="modalActualizarSolicitudLabel">Asignar gestor</h5>
