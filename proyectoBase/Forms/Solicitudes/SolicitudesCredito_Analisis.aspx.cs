...
public partial class SolicitudesCredito_Analisis : System.Web.UI.Page
{
    ...
    public void CargarInformacionClienteSolicitud()
    {
        ...
        //    var estadoSolicitudIngresada = (int)EstadosDeLaSolicitud.Ingresada;
        //    var estadoSolicitudEnCola = (int)EstadosDeLaSolicitud.EnCola;
        //    var estadoSolicitudEnAnalisis = (int)EstadosDeLaSolicitud.EnAnalisis;
        //    var estadoSolicitudCondicionada = (int)EstadosDeLaSolicitud.Condicionada;
        //    var estadoSolicitudRechazadaPorAnalista = (int)EstadosDeLaSolicitud.RechazadaPorAnalistas;
        //    var estadoSolicitudRechazadaPorGestores = (int)EstadosDeLaSolicitud.RechazadaPorGestores;
        //    var estadoSolicitudPasoFinal = (int)EstadosDeLaSolicitud.PasoFinal;
        //    var estadoSolicitudAutorizada = (int)EstadosDeLaSolicitud.Autorizada;
