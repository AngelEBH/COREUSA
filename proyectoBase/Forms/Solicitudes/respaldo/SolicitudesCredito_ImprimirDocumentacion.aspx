      ...
      <div id="divContenedorContratoPrestaditoCash" class="contenedorPDF">         
        <div class="card m-0 pt-4 divImprimir" runat="server" visible="true" id="divContratoPrestaditoCashPDF" style="display: none;">
           ...
           <br/>
               ...
               <br/>
               <%--tabla 2--%>
         <table style="width:100% ; height:20%;border:1px solid black; font-size:11px!important;" >

            <tr style="height: 30px;">
                <td colspan="4" style="width:60%;">Payment Schedule:</td>        
                <td colspan="4" rowspan="4" >
                     <table>
                          <tr> <td colspan="4" >Security: Borrower is giving a security interest in:</td></tr>                           
                          <tr>
                               <td colspan="2"><input type="checkbox" name="vehicle1" value="Bike"  style="width:30px;height:30px;">
                                 <label for="vehicle1"> Motor Vehicle</label><br></td>
                                <td colspan="2"><input type="checkbox" name="vehicle1" value="Bike"  style="width:30px;height:30px;">
                                 <label for="vehicle1">Mobile Home</label><br></td>
                          </tr>
                          <tr>
                               <td colspan="4">Late Charge:  If a  payment  is  more  than 	10  days  late, 
                                Borrower will berequired to pay a late charge of $15.00
                                </td>
                          </tr>
                     ...
                     <%-- <tr>--%>
                          <tr>
                           <td colspan="6">Prepayment: If Borrowerpays off early, Borrower: </td>
                          </tr>

                          <tr>
                            <td colspan="3"><input type="checkbox" name="vehicle1" value="Bike"  style="width:30px;height:30px;">
                                 <label for="vehicle1"> Will not</label></td>
                                 <td colspan="3"><input type="checkbox" name="vehicle1" value="Bike"  style="width:30px;height:30px;">
                                      <label for="vehicle1"> May</label></td>
                                      <td>
                                           have to pay a penalty and be entitled to a refund of part of the finance charge 
                                      </td>                      
                          </tr>
                     ...
                     <table>
                       <%--<tr>--%>
                         <tr>
                            <td colspan="6">Demand Feature: </td>
                          </tr>
                           <tr>
                             <td colspan="3"><input type="checkbox" name="vehicle1" value="Bike"  style="width:30px;height:30px;">
                                  <label for="vehicle1">Not applicable</label></td>
                                  <td colspan="3"><input type="checkbox" name="vehicle1" value="Bike"  style="width:30px;height:30px;">
                                       <label for="vehicle1">This obligation has a demand feature</label></td>                               
                           </tr>
          ...
          <tr style="height:50px;">
                ...
                <td colspan="2">When Payments are Due</td>                      
        
           </tr>
   <tr style="height:50px;" >
        <td>&nbsp; &nbsp; <asp:Label runat="server" ID="lblPlazoFinanciar_Cash"></asp:Label></td> 
        <td>&nbsp; &nbsp; <asp:Label runat="server" ID="lblValorCuota_Cash"></asp:Label></td>                         
        <td colspan="2">Frecuency: Bi-Weekly</td>                
   </tr>

     <tr >
        <td>&nbsp; &nbsp; 1</td> 
        <td>&nbsp; &nbsp; <asp:Label runat="server" ID="lblValorCuota_Cash2"></asp:Label></td>                         
        <td colspan="2">Beginning on:  <asp:Label runat="server" ID="lblPrimerPago_Cash"></asp:Label>  </td>                
   </tr>

   <tr>
        <td></td> 
        <td></td>                         
        <td colspan="2">Last payment on:  <asp:Label runat="server" ID="lblFechaVencimiento_Cash"></asp:Label>  </td>                
   </tr>

   <tr style="width:20%; height: 60px ">                                         
        <td colspan="4" style="width:20%">see the Disclosure Statement, Note and Security Agreement for any additional information about nonpayment, default, any required
             ...
             <div class="col-12">                      
              ...
              <div class="row">
                   <div class="col-12">
                       ...
                       <table>
                           <tr>
                               <td> <input type="checkbox" name="vehicle1" value="Bike"  style="width:30px;height:30px;"></td>
                               <td>
                                    <ol type="a">
                           <li>If this box is checked, you may prepay this loan in whole or in part at any time without penalty. However, upon partial prepayment, 
                           ...
                           <tr>
                               <td> <input type="checkbox" name="vehicle1" value="Bike"  style="width:30px;height:30px;"></td>
                               <td><ol>
                                        <li>If this box is checked and this loan is primarily secured by an interest in land, Borrower will be required to pay a prepayment penalty of 
                                           two
                       ...
                       <table>
                           <tr>
                               ...
                               <td>                                        
                                   <ol type="a">
                                    <li> If this box is checked, this loan is unsecured.</li>
                                   </ol>
                               </td>                            
                          </tr>
                           <tr>
                               ...
                               <td> <ol   type="a">
                                      <li >
                                             If this box is checked, to secure the payment and performance hereof, Borrower gives to Lender a security interest under the Uniform 
               ...
               <div class="row">
                ...
                <div class="col-12">
                   ...
                   <table>
                       <tr>
                           ...
                           <td>
                             <ol type="C">
                                ...
                                <li >
                                   If this box is checked, Borrower's loan is secured by Deed of Trust or Mortgage of even date on real property which requires Lender's X
                    ...
                    <p style="font-size:13px!important;">
                       <u> TAXES AND FEES:</u> Borrower will pay all taxes, assessments, and other fees payable on the Property, this Disclosure Statement, Note and Security Agreement, or the loan, including but not limited to any 
                        fee required by a public official to record the satisfaction of this loan, and/or the release of Lender's interest in the Property. If Borrower fails to pay such amounts, 
                        Lender may pay such amounts for Borrower and the amounts paid by Lender will be added to the unpaid balance of the loan.
                    </p>
                    ...
                    <ol>
                        ...
                        <li>
                            Any of Borrower's creditors attempts by legal process to take and keep any property of Borrower, including the Property securing this loan; 4. Borrower fails to fulfill any promise made under this agreement; or
                        </li>
                        <li>
           ...
           <br/>
               <div class="row mt-2">
                 ...
                 <div class="col-1"></div>
                   ...
                   <div class="col-5 text-center">
                       <asp:Label class="mt-5 form-control border-top-0 border-left-0 border-right-0 border-dark" ForeColor="Black" Style="border-radius: 0px;" runat="server" ID="lblNombrePropietarioGarantiaFirma_Cash"></asp:Label>
               ...
               <div class:"row">
                 ...
                 <div class="row justify-content-center">
                   <div class="col-5 text-center mt-1">
                       <label class="mt-5 form-control border-top-0 border-left-0 border-right-0 border-dark" style="border-radius: 0px;"></label>
                       <asp:Label runat="server" ID="LblNombreCLienteFirma_Cash"></asp:Label>
                   </div>
                   <div class="col-5 text-center mt-1">
                       <label class="mt-5 form-control border-top-0 border-left-0 border-right-0 border-dark" style="border-radius: 0px;"></label>                          
                       <label class="mt-0 d-block ">CESAR ROSENTHAL</label>
