        ...
        success: function (data) {
           ...
           // debugger;
            ...
            $('#lblTiempoResidirCliente').text(infoPersonal.fiTiempoResidir > 2 ? 'Más de 2 años' : infoPersonal.fiTiempoResidir + ' años');
             /* Informacion personal equifax Cliente */
            $('#lbIDFiscal').text(infoPersonal.fcNoIdFiscal);
            $('#lblDocumentoIdFiscal').text(infoPersonal.fcNombreDoctosIdPersonal);
            $('#lblOrigenEtnico').text(infoPersonal.fcDescricpcionOrigenEtnicoORacial);
           // $('#').text(infoPersonal.);
