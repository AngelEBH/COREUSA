...
function LlenarListasPrecalificado()
{
    $.ajax({
        type: "POST",
        url: "SolicitudesCredito_IngresarAval.aspx/LlenarListasPrecalificado",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
...
$("#btnConsultarCliente").click(function () {
    ...
    if ($('#frmSolicitud').parsley().isValid({ group: 'informacionPrecalificado' })) {
        ...
        $.ajax({
            type: "POST",
            url: "SolicitudesCredito_IngresarAval.aspx/precalificar",
...
function llenarDropDownLists() {
    ...
    $.ajax({
        type: "POST",
        url: "SolicitudesCredito_IngresarAval.aspx/getDDLS",
        contentType: 'application/json; charset=utf-8',
        error: function (xhr, ajaxOptions, thrownError) {
            MensajeError('No se pudo cargar la información, contacte al administrador');
        },
