$(document).ready(function () {
    ...
    $('#fileCedula').fileuploader({
        ...
        upload: {
            url: 'SolicitudesCredito_ActualizarSolicitud.aspx?type=upload&doc=1',
            data: null,
            type: 'POST',
    ...
    $('#fileCompDomicilio').fileuploader({
        ...
        upload: {
            url: 'SolicitudesCredito_ActualizarSolicitud.aspx?type=upload&doc=2',
            data: null,
            type: 'POST',
            enctype: 'multipart/form-data',
            start: true,
    ...
    $('#compIngresos').fileuploader({
        ...
        upload: {
            url: 'SolicitudesCredito_ActualizarSolicitud.aspx?type=upload&doc=3',
            data: null,
            type: 'POST',
            enctype: 'multipart/form-data',
            start: true,
    ...
    $('#croquisDomicilio').fileuploader({
        ...
        upload: {
            url: 'SolicitudesCredito_ActualizarSolicitud.aspx?type=upload&doc=4',
            data: null,
            type: 'POST',
            enctype: 'multipart/form-data',
            start: true,
    ...
    $('#croquisEmpleo').fileuploader({
        ...
        upload: {
            url: 'SolicitudesCredito_ActualizarSolicitud.aspx?type=upload&doc=5',
            data: null,
            type: 'POST',
            enctype: 'multipart/form-data',
            start: true,
    ...
    $('#soliFisica').fileuploader({
        ...
        upload: {
            url: 'SolicitudesCredito_ActualizarSolicitud.aspx?type=upload&doc=6',
            data: null,
            type: 'POST',
            enctype: 'multipart/form-data',
            start: true,
