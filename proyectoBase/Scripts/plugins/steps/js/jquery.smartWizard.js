  ...
  $.extend(SmartWizard.prototype, {
    ...
    _setToolbar: function () {
      ...
      if (this.options.toolbarSettings.toolbarPosition === 'none') {
        ...
        var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn btn-secondary sw-btn-next').attr('type', 'button') : $('<button style="display:none;"></button>').text(this.options.lang.next).addClass('btn btn-secondary sw-btn-next').attr('type', 'button');
    ...
    _setEvents: function () {
      ...
      if (this.options.keyNavigation) {
        $(document).keyup(function (e) {
          mi._keyNav(e); //habilitar/deshabilitar desplazarse por los pasos con las flechas del teclado
        });
    ...
    _fixHeight: function (idx) {
      // Auto adjust height of the container radiofaro
